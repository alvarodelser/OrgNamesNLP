...
from .evaluation_pipeline import (get_train_test, evaluate_reg_exp, evaluate_0shot, evaluate_semantic_sim, evaluate_supervised, get_metrics, get_analytics, compare_models)
...
__all__ = [
    ...
    'semantic_similarity_classifier_binary', 'semantic_similarity_classifier',
    'tfidf_classifier', 'word2vec_classifier',
    'get_train_test', 'evaluate_reg_exp', 'evaluate_0shot', 'evaluate_semantic_sim', 'evaluate_supervised', 'get_analytics', 'compare_models'
]